...
namespace DotNetty.Common.Internal
{
    ...
    public sealed class AppendableCharSequence : ICharSequence, IAppendable, IEquatable<AppendableCharSequence>
    {
        ...
        public int IndexOf(char ch, int start = 0) => CharUtil.IndexOf(this.chars, ch, start);
        ...
        public override bool Equals(object obj)
        {
            ...
            if (obj is ICharSequence sequence)
            {
        ...
        public AsciiString ToAsciiString() => this.pos == 0 ? AsciiString.Empty : new AsciiString(this.chars, 0, this.pos);
