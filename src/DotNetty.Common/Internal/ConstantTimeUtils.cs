...
namespace DotNetty.Common.Internal
{
    ...
    public static class ConstantTimeUtils
    {
      ...
      *     int v1 = 1;
      *     int v1 = 500;
      *     boolean equals = (Equals(l1, l2) & Equals(l3, l4)) != 0;
      * </pre>
      ...
      */
         ...
         * @return {@code 0} if not equal. {@code 1} if equal.
         */
        public static int Equals(long x, long y)
        {
            long z = -1L ^ (x ^ y);
            z &= z >> 32;
            z &= z >> 16;
         ...
         *     byte[] s3 = new {1, 2, 3};
         *     byte[] s4 = new {4, 5, 6};
         *     boolean equals = (Equals(s1, 0, s2, 0, s1.length) &
         *                       Equals(s3, 0, s4, 0, s3.length)) != 0;
         * </pre>
         ...
         * @return {@code 0} if not equal. {@code 1} if equal.
         */
        public static int Equals(byte[] bytes1, int startPos1, byte[] bytes2, int startPos2, int length)
        {
         ...
         *     String s3 = "foo";
         *     String s4 = "goo";
         *     boolean equals = (Equals(s1, s2) & Equals(s3, s4)) != 0;
         * </pre>
         * @param s1 the first value.
         * @param s2 the second value.
         * @return {@code 0} if not equal. {@code 1} if equal.
         */
        public static int Equals(ICharSequence s1, ICharSequence s2)
        {
