...
namespace DotNetty.Common.Utilities
{
    ...
    public sealed class StringBuilderCharSequence : ICharSequence, IEquatable<StringBuilderCharSequence>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is ICharSequence sequence && this.SequenceEquals(sequence, false);
        }
        ...
        public bool SequenceEquals(ICharSequence other, bool ignoreCase) => CharUtil.SequenceEquals(this, other, ignoreCase);
