...
namespace DotNetty.Common.Concurrency
{
    ...
    public abstract class AbstractScheduledEventExecutor : AbstractEventExecutor
    {
        ...
        protected IScheduledRunnable Schedule(IScheduledRunnable task)
        {
            ...
            {
                this.Execute((e, t) => ((AbstractScheduledEventExecutor)e).ScheduledTaskQueue.TryEnqueue((IScheduledRunnable)t), this, task);
            }
            return task;
        }
        ...
        internal void RemoveScheduled(IScheduledRunnable task)
        {
            ...
            {
                this.Execute((e, t) => ((AbstractScheduledEventExecutor)e).ScheduledTaskQueue.TryRemove((IScheduledRunnable)t), this, task);
            }
        }
    }
}