...
namespace DotNetty.Codecs.Http
{
    ...
    public class DefaultFullHttpRequest : DefaultHttpRequest, IFullHttpRequest
    {
        ...
        public IByteBufferHolder Replace(IByteBuffer newContent) => new DefaultFullHttpRequest(this.ProtocolVersion, this.Method, this.Uri, newContent, this.Headers, this.trailingHeader);
