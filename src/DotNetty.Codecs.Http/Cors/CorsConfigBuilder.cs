...
namespace DotNetty.Codecs.Http.Cors
{
    ...
    public sealed class CorsConfigBuilder
    {
        ...
        public static CorsConfigBuilder ForOrigin(ICharSequence origin) => CorsHandler.AnyOrigin.Equals(origin) ? new CorsConfigBuilder() : new CorsConfigBuilder(origin);

        public static CorsConfigBuilder ForOrigins(params ICharSequence[] origins) => new CorsConfigBuilder(origins);

        readonly HashSet<ICharSequence> exposeHeaders = new HashSet<ICharSequence>();
        readonly HashSet<HttpMethod> requestMethods = new HashSet<HttpMethod>();
        readonly HashSet<AsciiString> requestHeaders = new HashSet<AsciiString>();
        ...
        internal ISet<ICharSequence> ExposeHeaders => this.exposeHeaders;
        ...
        internal ISet<AsciiString> RequestHeaders => this.requestHeaders;
        ...
        public CorsConfigBuilder WithExposeHeaders(params ICharSequence[] headers)
        {
            ...
            {
                this.exposeHeaders.Add(headers[i]);
            }
