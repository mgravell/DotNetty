...
namespace DotNetty.Codecs.Http
{
    ...
    public class DefaultFullHttpResponse : DefaultHttpResponse, IFullHttpResponse
    {
        ...
        public IByteBufferHolder Replace(IByteBuffer newContent) => new DefaultFullHttpResponse(this.ProtocolVersion, this.Status, newContent, this.Headers, this.trailingHeaders);
