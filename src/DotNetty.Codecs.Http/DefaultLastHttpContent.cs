...
namespace DotNetty.Codecs.Http
{
    ...
    {
        static readonly TrailerNameValidator HeaderNameValidator = new TrailerNameValidator();
        ...
        {
            public TrailingHttpHeaders(bool validate) : base(validate, validate ? HeaderNameValidator : NotNullValidator)
            {
            }
        }
    }
