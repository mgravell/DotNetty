...
namespace DotNetty.Codecs.Http.Tests
{
    ...
    public sealed class HttpRequestDecoderTest
    {
        ...
        static IEnumerable<object[]> GetWholeRequestCases()
        {
            yield return new object[]
            {
                ContentCrlfDelimiters
            };
            ...
            yield return new object[]
            {
                ContentMixedDelimiters
            };
        }

        [Theory]
        [MemberData(nameof(GetWholeRequestCases))]
        public void DecodeWholeRequest(byte[] content)
        {
        ...
        [Theory]
        [MemberData(nameof(GetWholeRequestCases))]
        public void DecodeWholeRequestInMultipleSteps(byte[] content)
        {
