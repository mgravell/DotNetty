    ...
    public sealed class CorsConfigTest
    {
        ...
        public void ExposeHeaders()
        {
            CorsConfig cors = CorsConfigBuilder.ForAnyOrigin()
                .WithExposeHeaders((StringCharSequence)"custom-header1", (StringCharSequence)"custom-header2").Build();
        ...
        {
            CorsConfig cors = CorsConfigBuilder.ForAnyOrigin().WithAllowCredentials().Build();
        ...
        public void MaxAge()
        {
            CorsConfig cors = CorsConfigBuilder.ForAnyOrigin().WithMaxAge(3000).Build();
        ...
        {
            CorsConfig cors = CorsConfigBuilder.ForAnyOrigin()
                .PreflightResponseHeader((StringCharSequence)"SingleValue", (StringCharSequence)"value").Build();
        ...
        {
            CorsConfig cors = CorsConfigBuilder.ForAnyOrigin()
                .PreflightResponseHeader((StringCharSequence)"MultipleValues", (StringCharSequence)"value1", (StringCharSequence)"value2").Build();
